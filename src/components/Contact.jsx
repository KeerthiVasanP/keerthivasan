...
const Contact = () => {
  return (
    <div
      name="contact"
      className="w-full h-screen p-4 text-white bg-gradient-to-b from-gray-800 via-black to-black"
    >
      <div className="flex flex-col justify-center h-full max-w-screen-lg p-4 mx-auto">
        <div className="pb-8">
          <p className="inline text-4xl font-montserrat font-bold border-b-4 border-gray-500">
            Contact
          </p>
